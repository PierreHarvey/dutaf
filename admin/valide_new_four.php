...
<?php
    ...
    $requete = 'INSERT INTO fournisseur (four_nom, four_tel, four_ville) VALUES("'.$a.'","'.$b.'","'.$c.'")';
...
?>
<form>
        <INPUT type="submit" name="bouton" value="Valider" onClick="document.location='gest_four.php'"><BR><BR>
