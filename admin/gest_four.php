...
<div class="container">
        ...
        <a href="form_new_four.php"> Insérer un fournisseur</a> <br> <br> <br>
...
echo            '<table class="table">
                ...
                while($ligne = $exe->fetch())
                {
                    ...
                    echo'<tr>
                        <td>'.$ligne['four_id'].'</td>
                        <td>'.$ligne['four_nom'].'</td>
                        <td>'.$ligne['four_tel'].'</td>
                        <td>'.$ligne['four_ville'].'</td>
                        <td><a href="form_modif_four.php?id='.$ligne['four_id'].'">Modifier</a></td>
                        <td><a href="form_supp_four.php?id='.$ligne['four_id'].'">Supprimer</a></td>
                    </tr>';
                }
?>
