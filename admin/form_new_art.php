...
<form action="valide_new_art.php" method="POST">
        ...
        <p>Designation <input type='text' name='Designation'><br></p>
        <p>Description <input type='text' name='Description'><br></p>
        <p>Prix <input type='text' name='Prix'><br></p>
        <p>Quantité <input type='text' name='Quantité'><br></p>

        <INPUT type="submit" name="bouton" value="Valider"><BR><BR>
        <INPUT TYPE="BUTTON" VALUE="retour" onClick="document.location='gest_art.php'"><BR>
