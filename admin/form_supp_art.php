...
<form action="valide_supp_art.php" method="POST">

         <?php
        include ('config.inc.php');
        $bdd = new PDO('mysql:host='.BDD_SERVEUR.';dbname='.BDD_BDD.';charset=utf8',BDD_USER,BDD_PASS);
        $requete = 'SELECT * FROM catalogue WHERE art_id='.$_GET['id'];
        ...
        <p>Description <input type='text' name='Description' value='<?php echo $ligne['art_desc'] ?>'><br></p>
        <p>Prix <input type='text' name='Prix' value='<?php echo $ligne['art_prix'] ?>'><br></p>
        <p>Quantité <input type='text' name='Quantité' value='<?php echo $ligne['art_quant'] ?>'><br></p>
