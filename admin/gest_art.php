...
<div class="container">
        ...
        <a href="form_new_art.php"> Insérer un article</a> <br> <br> <br>
...
echo            '<table class="table">
                ...
                while($ligne = $exe->fetch())
                {
                    ...
                    echo'<tr>
                        ...
                        <td><a href="form_modif_art.php?id='.$ligne['art_id'].'">Modifier</a></td>
                        <td><a href="form_supp_art.php?id='.$ligne['art_id'].'">Supprimer</a></td>
                    </tr>';
                }
