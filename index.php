...
<div class="container">
    	...
    	Bienvenue sur le site de l'entreprise DUTAF (réalisé par Pierre HARVEY MMI S2D).<br> 
<!-- Merci de ne pas copié koeur koeur
================================================== -->
        Nous vous proposons un catalogue de produits en ligne. <br>
        Celui ci peut-être adapté à votre budget. <br> <br> <br>

        <img src="img/entreprise.jpg"> <br> <br> <br><br> <br> <br>
